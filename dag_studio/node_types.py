...
NODE_TYPES = [
    ...
    NodeTypeDefinition(
        ...
        fields=[
            ...
            NodeField(name="alpha", label="PC Alpha", kind="number", default=0.05),
            NodeField(name="variant", label="PC Variant", kind="select", default="original", options=["original", "stable", "parallel"]),
            NodeField(name="criterion", label="GES Criterion", kind="select", default="bic", options=["bic", "bdeu"]),
            NodeField(name="lambda1", label="lambda1", kind="number", default=0.03),
            NodeField(name="lambda2", label="lambda2", kind="number", default=0.01),
            NodeField(name="max_iter", label="Max Iter", kind="integer", default=100),
            NodeField(name="warm_iter", label="Warm Iter", kind="integer", default=1000),
            NodeField(name="T", label="T", kind="integer", default=5),
            NodeField(name="rank", label="Low Rank", kind="integer", default=2),
            NodeField(name="w_threshold", label="Threshold", kind="number", default=0.3),
            NodeField(name="seed", label="Seed", kind="integer", default=42),
            NodeField(name="library_params", label="Library Params", kind="json", default={}),
        ],
    ),
    NodeTypeDefinition(
        id="graph_view",
