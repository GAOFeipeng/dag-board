...
NODE_TYPES = [
    ...
    NodeTypeDefinition(
        ...
        fields=[
            ...
            NodeField(name="max_iter", label="Max Iter", kind="integer", default=200),
            NodeField(name="warm_iter", label="Warm Iter", kind="integer", default=100),
            NodeField(name="T", label="T", kind="integer", default=2),
