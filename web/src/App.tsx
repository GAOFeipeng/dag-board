...
function templateTranslationKey(
  templateId: WorkflowTemplateId,
): 'baselineCompare' | 'residualDataLoop' | 'algorithmSweep' | 'dataFusionAblation' {
  ...
  if (templateId === 'data_fusion_ablation') {
    return 'dataFusionAblation';
  }
